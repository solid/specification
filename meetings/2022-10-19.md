...
* HS: I have this proposal ??? Solid Wallet Launcher App. Different panels for apps you use. Apps from the web that you don't know that much can ask for ???. Two options - one server-side, one client-side. Looking for people to design that. Currently have a thing on the back of a napkin :) 
