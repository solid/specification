...
ACTION: eP to check how test suite uses versions
  * It seems very ad-hock, this examle shows commenting out and uncommenting version specific URLs https://github.com/solid-contrib/specification-tests/blob/main/protocol/solid-protocol-test-manifest.ttl#L8-L16
ACTION: eP to update 
...
### Tracking implementers feedback
https://github.com/solid/specification/issues/746

* eP: Theo still has action to contact Solid World presenters
* eP: I created 746, we can use differnt approach we still don't have clear process. I wouldn't like Sarven to make arbitrary decisions and close such issues. If he acts as Solid Protocol editor we couldd just separate implementation feedback from that CG draft and coordinate with LWS WG where the work continues. GH allows issues transfers and converting them in discussions so there are options on the table. I'm also fine with separating my suggestions from original feedback. As long as we track the original feedback it works for me.
...
* Hadrian: Indivdual in question only deleted content added by said person.  Github sends notifications to contributors following topic.  Notification not publicly available.
...
* SC: Revisit this issue in next meeting, with expectation a different audience will have additional input.
...
* SC: I'd like to provide a summary of these discussions, and happy to answer any questions. If eP is not available to discuss, I will not be forcing or seeking a "resolution" in this meeting. I'd like to give them a chance to respond to the objections that I've raised in the PR, and most importantly acknowledging prior work/decisions/publications, and so fort, of the Solid CG. That said, if PR 97 or https://github.com/solid/vocab/pull/98 or similar are agenda topics in the future, I request that I am present in the meeting to have my chance to respond to inquiries.
...
* SC: Expects not to be in attendance next week(10/8/25), requests issue not be resolved in my absence. I can attend 2025-10-15.
