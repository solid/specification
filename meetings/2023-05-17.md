...
* SC: There are lot of things in RFC-??? that we don't duplicate. We assume if you dive into Solid protocol, you know the expectations. Solid Protocol only adds new information that says things with a payload MUST have content type. 
