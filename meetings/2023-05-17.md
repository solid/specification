...
* JW: I agree that Solid shapes should be based on spec stuff. The goal of ??? is to be tied to npm to people can contribute/discover similar shapes to the ones in their app.
